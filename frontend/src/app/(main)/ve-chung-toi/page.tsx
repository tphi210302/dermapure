...
const MILESTONES = [
  { year: '2018', title: 'Thành lập', desc: 'Lumie ra đời với sứ mệnh mang dược mỹ phẩm chính hãng đến tay người Việt.' },
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-br from-primary-700 to-blue-800 text-white py-20 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-white/75 text-lg leading-relaxed max-w-xl mx-auto">
            Từ năm 2018, Lumie đã là người bạn đồng hành đáng tin cậy trong hành trình chăm sóc làn da của hàng chục nghìn khách hàng Việt Nam.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-14 space-y-16">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                Lumie ra đời với một mục tiêu duy nhất: giúp người Việt dễ dàng tiếp cận dược mỹ phẩm chính hãng, được dược sĩ da liễu tư vấn cá nhân hoá, với giá minh bạch.
              </p>
        ...
        <section className="bg-gradient-to-br from-primary-600 to-blue-700 rounded-3xl p-8 text-white text-center">
          ...
          <p className="text-white/75 text-sm mb-6">Tham gia cùng 50.000+ khách hàng đang tin tưởng Lumie.</p>
          <AboutCtaButtons />
        </section>
      </div>
    </div>
